...
def associate(
    ...
    try:
        ...
        for i in range(len(centers_init)):
            try:
                mask_i = pred == i
                tmp_data = data_[mask_i]
                tmp_locs = locs_[mask_i]
                tmp_pick_station_id = pick_station_id_[mask_i]
                tmp_phase_type = phase_type_[mask_i]
                # tmp_phase_weight = phase_weight_[mask_i]
