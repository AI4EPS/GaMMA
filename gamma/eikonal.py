...
def invert_location(
    data, event_t0, event_locs, station_locs, phase_type, weight, up, us, h, rgrid, zgrid, sigma=1, bounds=None
):
    ...
    def closure():
        optimizer.zero_grad()
        tt = t0_[0] + traveltime(loc_, station_locs, phase_type, up, us, h, rgrid, zgrid, sigma, bounds=bounds)
